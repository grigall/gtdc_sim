    class Constants:
        ...
        def __init__(self):
            ...
            self.players = (
                self.Player('Hollander', 19, 13, 9, None, 'good', 'Veteran Special Operator. Expert in jungle warfare. Not afraid of getting muddy.'),
                self.Player('Doug', 15, 12, 12, None, 'good','Mild-mannered construction worker. Likes demure women. Not a fan of parties.'),
                self.Player('Taskmaster',  18, 12, 10, None, 'good','Veteran Special Agent with an iron-clad secret identity. Sometimes has marital troubles. Not a fan of car salesmen.'),
                self.Player('Vector',  20, 15, 8, None, 'good','Commando by trade. Lumberjack by necessity. Father of the Year.')
            )
            ...
            self.minions = (
                ...
                self.Player('Svetlana', 15, 5, 9, None, 'bad',"Talented torturer. Known for making her patients talk… unless they pick the lock first."), 
                self.Player('Alien Hunter', 12, 6, 10, None, 'bad',"A hunter from another world who seeks the ultimate prey: you."), 
                self.Player('Killer Robot', 20, 15, 10, None, 'bad',"A cybernetic organism. A killing machine."), 
                ...
                self.Player('Cerulean Crusader', 10, 5, 7, None, 'bad',"Tired of all the other warm and fuzzy terrorist groups, these extremists formed their own, more extreme group."), 
            )

            self.bosses = (
                self.Player('Copenhaven', 12, 6, 10, None, 'bad',"A corporate dictator with a nasty temper."),
                ...
                self.Player('Vladimir Von Vlak', 18, 14, 12, None, 'bad',"Radical terrorist by day, equestrian by night."),
                self.Player('DYS-1000', 25, 17, 15, None, 'bad',"A cybernetic organism that can imitate anything it touches. The ultimate mimic. Nigh-unstoppable.")
            )